        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <jet-nav-link
                  ...
                  :active="route().current('tweets.followings')"
                >
                  Plans cul
                </jet-nav-link>
              </div>
            ...
            <jet-nav-link
              ...
              :active="route().current('messages.show')"
            >
              <img src="/img/icons/mail.png" class="w-8" alt="DU MIAIL" />
            </jet-nav-link>
        ...
        >
          ...
          <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
              ...
              <jet-dropdown-link :href="route('tweets.index')">
                Miaulis
              </jet-dropdown-link>

              <jet-dropdown-link :href="route('tweets.followings')">
                Plans cul
              </jet-dropdown-link>
